...
figure;
plot(D_M);
ylabel('MVN','fontsize',20);
xlabel('time [min]','fontsize',20);
title('Weights on MF-MVN synapses');
...
% Plot gain
figure;hold on
plot(1:start_train, D_G(1:start_train), 'r', 'linewidth', 2)
...
% Plot phase
figure;hold on
plot(day1, D_P(day1), 'g', 'linewidth', 2)
plot(day2, D_P(day2), 'g', 'linewidth', 2)
plot(day3, D_P(day3), 'g', 'linewidth', 2)
plot(day4, D_P(day4), 'g', 'linewidth', 2)
plot(nit1, D_P(nit1), 'b', 'linewidth', 2)
plot(nit2, D_P(nit2), 'b', 'linewidth', 2)
plot(nit3, D_P(nit3), 'b', 'linewidth', 2)
title('Phase');
