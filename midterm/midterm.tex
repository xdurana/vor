...
\includegraphics{images/cerebellum2.png}\footnote{\url{http://bit.ly/18Th2bA}}
...
\footnote{\url{http://bit.ly/1CJEXGv}}
...
\itemsep1pt\parskip0pt\parsep0pt
\item
  Two very differents signals affect indirectly the output of the
  cerebellum
\item
...
\begin{frame}{The cerebellum as an adaptive filter}

\includegraphics{images/adfilt.png}
...
\item
  Decorrelation rule
\item
  Minimizes correlations between eye movements as a predictor variable
  and retinal slip as a target variable
\item
